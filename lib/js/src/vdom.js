...
function patchVNodesOnElems_Properties(callbacks, elem, oldProperties, newProperties) {
  ...
  var elem$1 = elem;
  var _idx = 0;
  var _oldProperties = oldProperties;
  var _newProperties = newProperties;
  while(true) {
    var newProperties$1 = _newProperties;
    var oldProperties$1 = _oldProperties;
    var idx = _idx;
    if (oldProperties$1) {
      var oldProp = oldProperties$1[0];
      var exit = 0;
      if (newProperties$1) {
        if (typeof oldProp === "number") {
          if (typeof newProperties$1[0] === "number") {
            _newProperties = newProperties$1[1];
            _oldProperties = oldProperties$1[1];
            _idx = idx + 1 | 0;
            continue ;
          ...
          switch (oldProp.tag | 0) {
            case 0 : 
                ...
                if (typeof newProp === "number") {
                  ...
                  if (!(oldProp[0] === newProp[0] && oldProp[1] === newProp[1])) {
                    patchVNodesOnElems_PropertiesApply_Mutate(callbacks$1, elem$1, idx, oldProp, newProp);
                  }
                  _newProperties = newProperties$1[1];
                  _oldProperties = oldProperties$1[1];
                  _idx = idx + 1 | 0;
            ...
            case 1 : 
                ...
                break;
            case 2 : 
                var newProp$2 = newProperties$1[0];
                if (typeof newProp$2 === "number") {
                  exit = 1;
                } else if (newProp$2.tag === 2) {
                  if (!(oldProp[0] === newProp$2[0] && oldProp[1] === newProp$2[1])) {
                    patchVNodesOnElems_PropertiesApply_Mutate(callbacks$1, elem$1, idx, oldProp, newProp$2);
                  }
                  _newProperties = newProperties$1[1];
                  _oldProperties = oldProperties$1[1];
                  _idx = idx + 1 | 0;
                ...
                break;
            case 3 : 
                var _newProp = newProperties$1[0];
                if (typeof _newProp === "number") {
                  exit = 1;
                } else if (_newProp.tag === 3) {
                  eventHandler_Mutate(callbacks$1, elem$1, oldProp[0], _newProp[0], oldProp[1], _newProp[1], oldProp[2], _newProp[2]);
                  _newProperties = newProperties$1[1];
                  _oldProperties = oldProperties$1[1];
                  _idx = idx + 1 | 0;
                  continue ;
                ...
                break;
            case 4 : 
                var newProp$3 = newProperties$1[0];
                if (typeof newProp$3 === "number") {
                  exit = 1;
                } else if (newProp$3.tag === 4) {
                  if (!Caml_obj.caml_equal(oldProp[0], newProp$3[0])) {
                    patchVNodesOnElems_PropertiesApply_Mutate(callbacks$1, elem$1, idx, oldProp, newProp$3);
                  }
                  _newProperties = newProperties$1[1];
                  _oldProperties = oldProperties$1[1];
                  _idx = idx + 1 | 0;
      ...
      if (exit === 1) {
        patchVNodesOnElems_PropertiesApply_RemoveAdd(callbacks$1, elem$1, idx, oldProp, newProperties$1[0]);
        _newProperties = newProperties$1[1];
        _oldProperties = oldProperties$1[1];
        _idx = idx + 1 | 0;
        continue ;
  ...
  if (param.tag === 2) {
    ...
    if (match !== 0) {
      ...
      throw [
            ...
            [
              "/Users/yawar/code/bucklescript-tea/src/vdom.ml",
              316,
              30
            ]
          ];
